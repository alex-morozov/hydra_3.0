...
public class AddLink extends TestBase{
	@Parameters({ "sikuli" })	
	@Test
		public void addLink(String sikuli) throws FindFailed, InterruptedException, AWTException{
	...
	@Parameters({ "sikuli" })	
	@Test
		public void cancelAddingLink(String sikuli) throws FindFailed, InterruptedException, AWTException{
		BookHelper.openBook(BookManager.image, BookManager.openBook);
		ArticleHelper.openArticle(ArticleHelper.addPopUpObjectArticle);
		PopUpObjectsHelper.addLink(PopUpObjectsHelper.stringStart, PopUpObjectsHelper.stringFinish, PopUpObjectsHelper.highlightedText);
